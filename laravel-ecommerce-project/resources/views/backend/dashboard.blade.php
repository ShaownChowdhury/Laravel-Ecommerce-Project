                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="product">
                        <div class="image">
                          <img src="{{ asset('backend/assets/images/products/product-mini-1.jpg') }}" alt="" />
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="product">
                        <div class="image">
                          <img src="{{ asset('backend/assets/images/products/product-mini-2.jpg') }}" alt="" />
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="product">
                        <div class="image">
                          <img src="{{ asset('backend/assets/images/products/product-mini-3.jpg') }}" alt="" />
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="product">
                        <div class="image">
                          <img src="{{ asset('backend/assets/images/products/product-mini-4.jpg') }}" alt="" />
                        </div>
